...
public class Table {
  ...
  */
  public Object get(Symbol key) {
    ...
    // System.out.println("e.value class = " + (e.value != null ? e.value.getClass().getSimpleName() : "null"));
    return e.value;
  }
  }	
  ...
  */
  ...
  // if(value instanceof Semant.VarEntry) {
  //   Semant.VarEntry varEntry = (Semant.VarEntry) value;
  //   System.out.println("VarEntry Access class = " + (varEntry.access != null ? varEntry.access.getClass().getSimpleName() : "null"));
  // }
